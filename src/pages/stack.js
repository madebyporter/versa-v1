    ...
    <section className="block block-section">
      ...
      <div className="block-content g-m-1-13 g-l-4-12 g-4-12">
        <header className="block-content-header grid">
          <h3 className="t-36 block-content-title g-m-1-13 g-t-1-6">Stack Chart</h3>
        </header>
        <ul className="list-bordered resume-list">
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Photo editing.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Photography</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              <li className="t-24 g-m-1-13 g-t-1-5 g-l-1-4 g-1-4"><Link to="https://www.figma.com" target="_blank">Affinity Designer</Link></li>
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Vector based design.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Graphic Design</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              <li className="t-24 g-m-1-13 g-t-1-5 g-l-1-4 g-1-4"><Link to="https://www.figma.com" target="_blank">Affinity Photo</Link></li>
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Raster based design.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Graphic Design</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Video editing.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Cinematography</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              <li className="t-24 g-m-1-13 g-t-1-5 g-l-1-4 g-1-4"><Link to="https://www.figma.com" target="_blank">Figma</Link></li>
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Collaborative product design.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Product Design</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              <li className="t-24 g-m-1-13 g-t-1-5 g-l-1-4 g-1-4"><Link to="https://www.slack.com" target="_blank">Slack</Link></li>
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Offline product design.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Product Design</li>
            </ul>
          </li>
          <li>
          ...
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Stock Photos.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Photography</li>
            </ul>
          </li>
        </ul>
        ...
        <ul className="list-bordered resume-list">
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">React for websites.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Javascript</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              <li className="t-24 g-m-1-13 g-t-1-5 g-l-1-4 g-1-4"><Link to="https://github.com/" target="_blank">Github</Link></li>
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Git repository.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Tool</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              <li className="t-24 g-m-1-13 g-t-1-5 g-l-1-4 g-1-4"><Link to="https://hyper.is/" target="_blank">Hyper</Link></li>
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Electron based terminal.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Tool</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">OG Jamstack Framework.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Ruby</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              <li className="t-24 g-m-1-13 g-t-1-5 g-l-1-4 g-1-4"><Link to="https://www.netlify.com" target="_blank">Netlify</Link></li>
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Jamstack hosting.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Hosting</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              <li className="t-24 g-m-1-13 g-t-1-5 g-l-1-4 g-1-4"><Link to="https://code.visualstudio.com/" target="_blank">VS Code</Link></li>
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Code websites &amp; apps.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Tool</li>
            </ul>
          </li>
        </ul>
        ...
        <ul className="list-bordered resume-list">
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Compose music.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">DAW</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Synth wave table.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Plugin</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Synth emulators.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Plugin</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Condenser microphone.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Hardware</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              <li className="t-24 g-m-1-13 g-t-1-5 g-l-1-4 g-1-4"><Link to="https://futureaudioworkshop.com/" target="_blank">FAW Sublab</Link></li>
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Sub bass synth.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Plugin</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Engineer music.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">DAW</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Mixing &amp; mastering tools.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Plugin</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Sampler Subscription</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Plugin</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">USB audio interface.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Hardware</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Film composer instruments.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Plugin</li>
            </ul>
          </li>
        </ul>
        ...
        <ul className="list-bordered resume-list">
          ...
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">For Gmail &amp; G-Docs.</li>
          ...
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Startup neo-banking.</li>
          ...
          <li>
            <ul className="list-item-columns g-align-items-end">
              <li className="t-24 g-m-1-13 g-t-1-5 g-l-1-4 g-1-4"><Link to="https://www.slack.com/" target="_blank">Slack</Link></li>
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Project communication</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Communication</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Manage multiple email accounts.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Communication</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Accounting software.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Finances</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Automation</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Productivity</li>
            </ul>
          </li>
        </ul>
        ...
        <ul className="list-bordered resume-list">
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Booking places to stay.</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Tools</li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-1-8 g-t-5-10 g-l-5-9 g-5-9">Backpack</li>
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">Gear</li>
            </ul>
          </li>        
        </ul>
      </div>
