      ...
      <div className="block-content g-m-1-13 g-l-4-12 g-4-12">
        ...
        <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-12-13 g-t-12-13 g-l-12-13 g-12-13 g-align-items-center"><span className="status status-green" /></li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
          ...
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-12-13 g-t-12-13 g-l-12-13 g-12-13 g-align-items-center"><span className="status status-yellow" /></li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
          ...
          <li>
            <ul className="list-item-columns g-align-items-end">
              ...
              <li className="t-18 g-m-8-12 g-t-10-12 g-l-10-12 g-10-12">2017–2018</li>
              <li className="t-18 g-m-12-13 g-t-12-13 g-l-12-13 g-12-13 g-align-items-center"><span className="status status-red" /></li>
            </ul>
          </li>
          <li>
            <ul className="list-item-columns g-align-items-end">
          ...
          <li>
            <ul className="list-item-columns g-align-items-end">
              <li className="t-24 g-m-1-13 g-t-1-5 g-l-1-5 g-1-5"><a href="https://myfdtps.netlify.app/" target="_blank" rel="noreferrer">Foundation Transportation</a></li>
